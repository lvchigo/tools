...
close all
%%/home/zougp/Data/
spatialenvelope_db_dir = '/home/zougp/Data/faces/mark';
spatialenvelope_db_mat = '/home/zougp/Data/feature/mark_db.mat';
spatialenvelope_gist_mat = '/home/zougp/Data/feature/mark_gist.mat';
...
best_c = 512;
best_g = 0.5;
options = sprintf('-s 0 -t 0 -c %f -b 1 -g %f -q',best_c,best_g);
