...
close all
%%
spatialenvelope_db_dir = '/home/zougp/Data/scene_categories_15';
spatialenvelope_db_mat = '/home/zougp/Data/feature/scene_categories_15_db.mat';
spatialenvelope_gist_mat = '/home/zougp/Data/feature/scene_categories_15_gist.mat';
...
convert_to_svm_format(train_label, train_gist, 'train_15.gist');
convert_to_svm_format(test_label, test_gist, 'test_15.gist');
%% svm trainning...
disp('svm trainning...');

best_c = 20;
best_g = 2;
options = sprintf('-s 0 -t 1 -c %f -b 1 -g %f -q',best_c,best_g);
...
figure(2)
[R , mat_conf] = perf_classif(test_label', predicted_label');
p_matconf = mat_conf./repmat(sum(mat_conf, 1)', 1, nclass);
plot_confusion_matrix(p_matconf, cnames)

figure(3)
[tp , fp , threshold] = basicroc(test_label', prob_estimates(:,1));
plot(fp , tp  , 'linewidth' , 2);

save test_label.mat test_label
save predicted_label.mat predicted_label
save prob_estimates.mat prob_estimates